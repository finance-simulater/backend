...
class StockRepository:
    ...
    def find_by_user_and_type(self, user_id: int, stock_type: str) -> StockHolding | None:
        return (
            self.db.query(StockHolding)
            .filter(
    ...
    def find_simulation_state(self, user_id: int) -> SimulationState | None:
        return (
            self.db.query(SimulationState)
